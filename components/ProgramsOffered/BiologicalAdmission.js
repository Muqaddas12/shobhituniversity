...
const BiologicalAdmission = () => {
  ...
  const applyLink = 'https://sug.ac.in/school-of-biological-engineering/admission.php'; // Placeholder link, adjust as needed

  return (
    <ScrollView style={styles.container}>
      <Text style={styles.mainTitle}>School of Biological Engineering & Sciences</Text>

      {/* M.Sc. Program Section */}
      <View style={styles.programCard}>
        <TouchableOpacity onPress={() => toggleProgram('msc')} style={styles.programTitleContainer}>
          <Text style={styles.programTitle}>M.Sc.</Text>
          <Text style={styles.toggleIcon}>{mscExpanded ? '▲' : '▼'}</Text>
        </TouchableOpacity>

        {mscExpanded && ( // Conditionally render content if expanded
          <View style={styles.programContent}>
            <Text style={styles.detailText}>Microbiology</Text>
            ...
            <Text style={styles.detailText}>
              Admission to M.Sc. Programs is open to a Graduate from a recognized university in the relevant/ allied branch.
            </Text>
      ...
      {/* B.Sc. (Honors) Program Section */}
      <View style={styles.programCard}>
        <TouchableOpacity onPress={() => toggleProgram('bscHonors')} style={styles.programTitleContainer}>
          <Text style={styles.programTitle}>B.Sc. (Honors)</Text>
          <Text style={styles.toggleIcon}>{bscHonorsExpanded ? '▲' : '▼'}</Text>
        </TouchableOpacity>

        {bscHonorsExpanded && ( // Conditionally render content if expanded
          <View style={styles.programContent}>
            <Text style={styles.detailText}>Microbiology</Text>
            <Text style={styles.detailText}>Duration: <Text style={styles.boldText}>3 Yrs.</Text></Text>
            <Text style={styles.subHeading}>Eligibility:</Text>
            <Text style={styles.detailText}>
              Admission to B.Sc. Programs is open to candidates who have passed (10+2) / Intermediate / Higher Secondary from any approved Board with PCM/PCB.
            </Text>
            <View style={styles.feeTable}>
              <Text style={styles.feeItem}>Administrative Charge: <Text style={styles.feeAmount}>Rs.5,000/- Per Annum</Text></Text>
              <Text style={styles.feeItem}>University Charges: <Text style={styles.feeAmount}>Rs.10,000/- Per Annum</Text></Text>
              <Text style={styles.feeItem}>Tuition Fee: <Text style={styles.feeAmount}>Rs.15,000/- Per Annum</Text></Text>
              <Text style={styles.feeItem}>Caution Money (Refundable): <Text style={styles.feeAmount}>Rs.5,000/-</Text></Text>
              <Text style={styles.feeItem}>Hostel Charges per Academic year: <Text style={styles.feeAmount}>Rs.75,000/-</Text></Text>
              <Text style={styles.feeItem}>Hostel Security Amount (Refundable): <Text style={styles.feeAmount}>Rs.5,000/-</Text></Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  websiteButton: { // Included for consistency, though not explicitly requested for Biological
...
export default BiologicalAdmission;
